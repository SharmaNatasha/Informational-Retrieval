...
public class TestDiffAvgPosFeatureDSM extends ApplicationSetupBasedTest
{
	@Test public void testOneDocTwoTerms1() throws Exception {
		...
		DiffAvgPositionDSM testAvgPos = new DiffAvgPositionDSM();
		double score = testAvgPos.calculateDependence(
            ips, //posting lists
	...
	@Test 
	public void testOneDocTwoTerms2() throws Exception {

		//make an index with a single sample document
		ApplicationSetup.setProperty("termpipelines", "");
		Index index = IndexTestUtils.makeIndexBlocks(
				new String[]{"doc1"}, 
				new String[]{"The quick brown fox jumps over the fox lazy dog"});
	...
	@Test 
	public void testOneDocTwoTerms3() throws Exception {

		//make an index with a single sample document
		ApplicationSetup.setProperty("termpipelines", "");
		Index index = IndexTestUtils.makeIndexBlocks(
				new String[]{"doc1"}, 
				new String[]{"The quick brown fox jumps over the fox lazy dog jumps"});
